...
afstokenchecker.sh "Starting execution of Monitor_NoiseRatios_V3 $1 $2"
...
STORAGEPATH=/data/users/event_display/CondDBMonitoringWebInterface/CondDBMonitoringWebInterface/WWW/$STORAGEDIR
...
# grep modified to get ONLY the SiStripApvGainRcd but not the SiStripApvGain2Rcd nor the SiStripApvGainSimRcd
    ...
    afstokenchecker.sh "GLOBAL \ NOISE:"
    afstokenchecker.sh "$globaltag $NOISETAG"
