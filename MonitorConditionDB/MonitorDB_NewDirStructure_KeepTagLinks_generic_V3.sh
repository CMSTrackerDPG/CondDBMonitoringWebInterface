...
afstokenchecker.sh "Starting execution of MonitorDB_NewDirStructure_KeepTagLinks_generic_V3 $1 $2 $3"
...
STORAGEPATH=/data/users/event_display/CondDBMonitoringWebInterface/CondDBMonitoringWebInterface/WWW/CondDBMonitoring
WORKDIR=$PWD


WWWPATH=/data/users/event_display/CondDBMonitoringWebInterface/CondDBMonitoringWebInterface/WWW

#Function to publish png pictures on the web. Will be used at the end of the script:
CreateIndex ()
{
    # cp /data/users/event_display/CondDBMonitoringWebInterface/CondDBMonitoringWebInterface/WWW/index_new.html .
    cp $WWWPATH/index_new.html .
...
echo MonitorDB_NewDirStructure_KeepTagLinks_generic_V3
